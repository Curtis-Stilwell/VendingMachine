...
//  VendingMachine
//
//  Created by Curtis Stilwell on 4/14/18.
    ...
    @IBAction func purchase() {
        if let currentSelection = currentSelection {
            do {
                ...
                showAlert(title:"Out of stock", message: "The items is unavilable. Please make another selection")
                ...
                showAlert(title:"Insufficent Funds", message: message)
            } catch let error  {
                fatalError("\(error)")
            }
